...
/*
import SpecialProducts from "../../../../Headless-Commerce/src/app/components/SpecialProducts";
import Navigation from "../../../../Headless-Commerce/src/app/components/Navigation";
import { Link } from "react-router-dom";
import Axios from "axios";
import SpecialProducts2 from "../../../../Headless-Commerce/src/app/components/SpecialProducts2";
*/
class Home extends Component {
  ...
  componentDidMount() {
    //Axios.get("https://swapi.co/api/people/1") //replace with endpoint in live mode
    //Axios.get("./featuredProducts.json") // didn't work
    //Axios.get("http://localhost/data/featuredProducts.json") //didnt work
    //Axios.get("../../server/data/featuredProducts.json") // didn't work
    //Axios.get("/data/featuredProducts.json") // didn't work
    Axios.get("../featuredProducts.json") // Testing in progress
      .then(response => {
        console.log(
    ...
    Axios.get("../../public/currentTrendingProducts.json")
      .then(response => {
        return response.data;
      })
      .then(data => {
    ...
    Axios.get("../../public/bestSellerProducts.json")
      .then(resposne => {
    ...
    Axios.get("../../public/trendingProducts.json")
      .then(resposne => {
        return resposne.data;
      })
      .then(data => {
    ...
    Axios.get("../../public/recommendedProduct.json")
      .then(resposne => {
        return resposne.data;
      })
      .then(data => {
